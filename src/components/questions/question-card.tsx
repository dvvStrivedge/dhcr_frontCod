...
export default function QuestionCard({ question }: QuestionCardProps) {
  ...
  return (
    <div className="border-t border-light-500 py-5 first:border-t-0 dark:border-dark-400">
      <p className="mb-1.5 text-13px font-bold text-base text-dark dark:text-light">
        <span className="inline-block uppercase ltr:mr-1 rtl:ml-1">Q:</span>
        {userQuestion}
      </p>
      {answer && (
        <p className="text-13px leading-[1.85em] text-dark-600 dark:text-light-600 text-base ">
      ...
      <div className="mt-5 flex list-disc items-center space-x-3 text-13px marker:text-sky-400 rtl:space-x-reverse sm:space-x-4">
        <div className="flex items-center text-dark-800 after:inline-block after:h-1 after:w-1 after:rounded-full after:bg-dark-900 ltr:after:ml-3 rtl:after:mr-3 dark:text-light-900 after:dark:bg-light-900 ltr:sm:after:ml-4 rtl:sm:after:mr-4 text-sm ">
        ...
        <div className="flex items-center space-x-3 rtl:space-x-reverse sm:space-x-4">
          <button
            className={cn(
              'flex items-center tracking-wider text-dark-800 transition text-white',
              {
