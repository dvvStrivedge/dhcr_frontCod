...
import ZoomImageModal from '../review/zoom-image-modal';
...
const OrderInfoViewModal = dynamic(
  () => import('@/components/orders/order-info-view-modal')
);
...
function renderModalContent(view: MODAL_VIEWS) {
  switch (view) {
    ...
    case 'INFO_VIEW':
      return <OrderInfoViewModal />;
    case 'ZOOM_IMAGE_VIEW':
